...
"""
Contagra OAuth2 Class
"""

__title__ = "commerce-oauth"
__version__ = "1.0.0"
__author__ = "Contagra"
__license__ = "MIT"
...
class OAuth(object):
    ...
    def __init__(self, url, username, api_key, api, **kwargs):
        self.url = url
    ...
    def get_oauth_url(self):
        ...
        return f"{url}/{api}/{version}/auth/get_tokens?{query_string}"
    ...
    def generate_oauth_signature(self, params, url):
        ...
        consumer_secret = str(self.api_key)
