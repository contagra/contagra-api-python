...
import unittest
import contagra
from contagra import oauth
from httmock import all_requests, HTTMock


class ContagraTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.api = contagra.API(
            url="http://admin.contagra.com",
    ...
    def test_version(self):
        ...
        self.assertEqual(api.version, "contagra/v1")
    ...
    def test_with_timeout(self):
        ...
        @all_requests
        def contagra_test_mock(*args, **kwargs):
            """ URL Mock """
            return {'status_code': 200,
                    'content': 'OK'}

        with HTTMock(contagra_test_mock):
            # call requests
